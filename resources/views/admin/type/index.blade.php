...
@section('content')
    ...
    <div class="container-fluid mb-3" id="newBtnSection">
        <button class="btn btn-primary" id="newBtn">Add New Type</button>
    </div>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h4 id="cardTitle">Add New Type</h4>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(function() {
            ...
            $('#addBtn').click(function() {
                var btn = this;
                var url = $(btn).val() === 'Create' ? "{{ route('types.store') }}" :
                    "{{ route('types.update') }}";
            ...
            $(document).on('click', '.EditBtn', function() {
                var id = $(this).data('id');
                $.get("{{ url('/admin/type') }}/" + id + "/edit", {}, function(res) {
                    $('#codeid').val(res.id);
                    $('#name').val(res.name);
                    $('#cardTitle').text('Update Type');
