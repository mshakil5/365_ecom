                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/products/img-1.png"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/products/img-2.png"
                                                                        alt="" class="img-fluid d-block" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-14 my-1"><a
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/products/img-3.png"
                                                                        alt="" class="img-fluid d-block" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-14 my-1"><a
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/products/img-4.png"
                                                                        alt="" class="img-fluid d-block" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-14 my-1"><a
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/products/img-5.png"
                                                                        alt="" class="img-fluid d-block" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-14 my-1"><a
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/companies/img-1.png"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/companies/img-2.png"
                                                                        alt="" class="avatar-sm p-2" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <h5 class="fs-14 my-1 fw-medium"><a
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/companies/img-3.png"
                                                                        alt="" class="avatar-sm p-2" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/companies/img-8.png"
                                                                        alt="" class="avatar-sm p-2" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <h5 class="fs-14 my-1 fw-medium"><a
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/companies/img-5.png"
                                                                        alt="" class="avatar-sm p-2" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <h5 class="fs-14 my-1 fw-medium"><a
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/users/avatar-1.jpg"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/users/avatar-2.jpg"
                                                                        alt="" class="avatar-xs rounded-circle" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/users/avatar-3.jpg"
                                                                        alt="" class="avatar-xs rounded-circle" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/users/avatar-4.jpg"
                                                                        alt="" class="avatar-xs rounded-circle" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{ asset('resources') }}/backend/images/users/avatar-6.jpg"
                                                                        alt="" class="avatar-xs rounded-circle" />
                                                                </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                                    <div class="acitivity-timeline acitivity-main">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                    <a href="apps-ecommerce-product-details.html"
                                                        ...
                                                        <img src="{{ asset('resources') }}/backend/images/products/img-8.png" alt=""
                                                            class="img-fluid d-block" />
                                                    </a>
                                                    <a href="apps-ecommerce-product-details.html"
                                                        class="bg-light rounded p-1">
                                                        <img src="{{ asset('resources') }}/backend/images/products/img-2.png" alt=""
                                                            class="img-fluid d-block" />
                                                    </a>
                                                    <a href="apps-ecommerce-product-details.html"
                                                        class="bg-light rounded p-1">
                                                        <img src="{{ asset('resources') }}/backend/images/products/img-10.png" alt=""
                                                            class="img-fluid d-block" />
                                                    </a>
                                                </div>
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('resources') }}/backend/images/users/avatar-2.jpg" alt=""
                                        ...
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('resources') }}/backend/images/users/avatar-3.jpg" alt=""
                                                    class="avatar-xs rounded-circle acitivity-avatar" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
