...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-layout="vertical" data-topbar="light" data-sidebar="dark"
    ...
    @php
        $company = App\Models\CompanyDetails::select('company_name', 'fav_icon', 'company_logo')->firstOrCreate();
    @endphp
  ...
  <head>
      ...
      <!-- Swiper slider css -->
      <link href="{{ asset('resources/backend/libs/swiper/swiper-bundle.min.css') }}" rel="stylesheet"
          type="text/css" />

      <link href="{{ asset('resources/backend/libs/dropzone/dropzone.css') }}" rel="stylesheet" type="text/css" />
      ...
      <link rel="stylesheet" href="{{ asset('resources/backend/libs/flatpickr/flatpickr.min.css') }}">
  ...
  <body>
      ...
      <script src="{{ asset('resources/backend/libs/node-waves/waves.min.js') }}"></script>
      <script src="{{ asset('resources/backend/libs/feather-icons/feather.min.js') }}"></script>
      <script src="{{ asset('resources/backend/js/pages/plugins/lord-icon-2.1.0.js') }}"></script>
      <script src="{{ asset('resources/backend/js/plugins.js') }}"></script>

      <!-- apexcharts -->
      {{-- <script src="{{ asset('resources/backend/libs/apexcharts/apexcharts.min.js') }}"></script> --}}

      <!-- Vector map -->
      <script src="{{ asset('resources/backend/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
      <script src="{{ asset('resources/backend/libs/jsvectormap/maps/world-merc.js') }}"></script>

      <!-- Swiper slider js -->
      <script src="{{ asset('resources/backend/libs/swiper/swiper-bundle.min.js') }}"></script>

      <!-- Dashboard init -->
      {{-- <script src="{{ asset('resources/backend/js/pages/dashboard-ecommerce.init.js') }}"></script> --}}

      <script src="{{ asset('resources/backend/libs/flatpickr/flatpickr.js') }}"></script>
