...
@section('content')
    ...
    <div class="container-fluid mb-3" id="newBtnSection">
        <div class="row">
            <div class="col-auto">
                <button class="btn btn-primary" id="newBtn">Add New Size</button>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-header">
                        <h4 id="cardTitle">Add New Size</h4>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(function() {
            ...
            $('#addBtn').click(function() {
                var btn = this;
                var url = $(btn).val() === 'Create' ? "{{ route('sizes.store') }}" :
                    "{{ route('sizes.update') }}";
            ...
            $(document).on('click', '.EditBtn', function() {
                var id = $(this).data('id');
                $.get("{{ url('/admin/size') }}/" + id + "/edit", {}, function(res) {
                    $('#codeid').val(res.id);
                    $('#name').val(res.name);
                    $('#cardTitle').text('Update Size');
